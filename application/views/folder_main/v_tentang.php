...
<body>
  ...
  <div id="body">
    <div id="menu">
      <ul>
        <li><a href="<?php echo base_url('folder_main/main'); ?>">Home</a></li>
        <li><a href="<?php echo base_url('folder_main/v_tentang'); ?>">Tentang Sekolah</a></li>
        <li><a href="<?php echo base_url('folder_main/v_kontak'); ?>">Kontak Sekolah</a></li>
      </ul>
    </div>
    ...
    <div id="welcomeContainer" class="daftar">
        <a href="<?php echo base_url('daftar'); ?>">Mendaftar Sekolah</a>
    </div>
</body>
