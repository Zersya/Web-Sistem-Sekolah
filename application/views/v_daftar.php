...
<body>
  <div id="body">
    <table border="0" class="table">
      ...
      <tr>
        <td>Nilai Akhir </td>
        <td><input type="text" class="Infield" name="nilaiAkhirMTK" placeholder="Masukan Nilai Akhir MTK Anda" size="45"></td>
      </tr>
      <tr>
        <td>Nilai UN </td>
        <td><input type="text" class="Infield" name="nilaiUNMTK" placeholder="Masukan UN MTK Anda" size="45"></td>
      </tr>
      <tr>
        <td colspan="2"><div class="line-separator"></div></td>
      </tr>
      ...
      <tr>
        <td>Nilai Akhir </td>
        <td><input type="text" class="Infield" name="nilaiAkhirBIND" placeholder="Masukan Nilai Akhir B.Ind Anda" size="45"></td>
      </tr>
      <tr>
        <td>Nilai UN </td>
        <td><input type="text" class="Infield" name="nilaiUNBIND" placeholder="Masukan UN B.Ind Anda" size="45"></td>
      </tr>
      <tr>
        <td colspan="2"><div class="line-separator"></div></td>
      </tr>
      ...
      <tr>
        <td>Nilai Akhir </td>
        <td><input type="text" class="Infield" name="nilaiAkhirBING" placeholder="Masukan Nilai Akhir B.Inggris Anda" size="45"></td>
      </tr>
      <tr>
        <td>Nilai UN </td>
        <td><input type="text" class="Infield" name="nilaiUNBING" placeholder="Masukan UN B.Inggris Anda" size="45"></td>
      </tr>
      <tr>
        <td colspan="2"><div class="line-separator"></div></td>
      </tr>
